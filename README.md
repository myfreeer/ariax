...
ownership, journal v1 framing/replay, and scalar typed-payload foundations are
implemented. Module work remains governed by `implementation-readiness.md` and
the phase exit criteria in `implementation-plan.md`.
