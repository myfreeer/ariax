...
Several documents defer to a "redirect policy" ([detailed-http-first-slice.md](detailed-http-first-slice.md),
[retry-policy.md](retry-policy.md), [library-choice.md](../architecture/library-choice.md)) but none defined it. This document owns
...
case-insensitive reserved-header policy in [detailed-http-first-slice.md](detailed-http-first-slice.md), and
...
- Resolve and re-check the redirect target against the SSRF guardrail in
  [security-recovery.md](../architecture/security-recovery.md) (generated non-global/special-use and metadata-endpoint
