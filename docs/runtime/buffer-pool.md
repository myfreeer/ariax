...
copied payload bytes. Queue selection is defined in [messaging-model.md](messaging-model.md).
...
[detailed-runtime.md](detailed-runtime.md).
...
pointer/capacity/owner form defined in [detailed-runtime.md](detailed-runtime.md). This document does
