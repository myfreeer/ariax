...
([detailed-core.md](../architecture/detailed-core.md)) and involves no queue movement at all.
...
Readmission must apply the [detailed-core.md](../architecture/detailed-core.md) readmission generation rule: the
