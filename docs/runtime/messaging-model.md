...
[implementation-readiness.md](../project/implementation-readiness.md) tracks validation and platform gates.
...
is bounded-burst, not absolute priority; see [detailed-runtime.md](detailed-runtime.md) Queue
Topology.
...
in [threading-model.md](threading-model.md).
...
[performance-profiles.md](performance-profiles.md). When method-token authentication is configured,
...
immediate. [apis-and-embedding.md#event-delivery-and-slow-consumers](../interfaces/apis-and-embedding.md#event-delivery-and-slow-consumers) owns this
...
- holding a *filled* buffer while waiting for unrelated queue capacity (an
  ...
  backpressure flow in [detailed-runtime.md](detailed-runtime.md), which reserves storage credit
