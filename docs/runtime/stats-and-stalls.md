...
- `taskState`: the closed canonical lifecycle state from [detailed-core.md](../architecture/detailed-core.md).
...
discard safety budget in [rate-limiting.md](rate-limiting.md) independently resets a source that
...
It also lets [download-scheduling.md](download-scheduling.md) free slots only for remote slowness, not
