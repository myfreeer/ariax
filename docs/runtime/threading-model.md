...
remain roadmap contracts. Current evidence is in [implementation-readiness.md](../project/implementation-readiness.md).
...
[messaging-model.md](messaging-model.md) for the concrete choices: Tokio channels for control,
...
- structural control/journal priority: split urgent/bulk external lanes with
  ...
  external producers cannot consume ([messaging-model.md](messaging-model.md)),
