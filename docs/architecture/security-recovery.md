...
owned by [detailed-storage.md](../storage/detailed-storage.md). This document adds policy constraints; it does
...
root. [detailed-storage.md](../storage/detailed-storage.md) owns the canonical capability-bearing API and
...
[apis-and-embedding.md#event-delivery-and-slow-consumers](../interfaces/apis-and-embedding.md#event-delivery-and-slow-consumers).
...
[Architecture overview](overview.md) promises that redirects, proxies, and DNS resolution obey SSRF
...
RPC listener (and always for redirect targets, see [redirect-policy.md](../protocols/redirect-policy.md)):
...
- Proxy interaction: the guardrail validates both the proxy endpoint and the
  ...
  See [protocol-modernization.md](../protocols/protocol-modernization.md).
...
[detailed-storage.md](../storage/detailed-storage.md). This section states only the security-relevant
...
enum in [detailed-storage.md](../storage/detailed-storage.md).

The primary persistence model is described in [session-persistence.md](../storage/session-persistence.md): global
...
- the flushed `FinalizeIntent` plus temp/final presence, recorded length, and
  ...
  ([detailed-storage.md](../storage/detailed-storage.md) Idempotent Rename Recovery),
