...
- `PausedSlow` is produced only by the [download-scheduling.md](../runtime/download-scheduling.md) slow-slot
...
a delayed retry-ready event cannot admit the old source set.
