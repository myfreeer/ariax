...
- Use [implementation-readiness.md](implementation-readiness.md) as the readiness gate for all later module
  work.
...
- Pin the direct choices in [library-choice.md](../architecture/library-choice.md), record feature unification and
...
- [detailed-core.md](../architecture/detailed-core.md)
- [detailed-config.md](../interfaces/detailed-config.md)
- [detailed-storage.md](../storage/detailed-storage.md)
- [detailed-runtime.md](../runtime/detailed-runtime.md)
...
- 1,000 active HTTP range benchmark with bounded memory. The checked-in harness
  ...
  recorded in [performance-profiles.md](../runtime/performance-profiles.md); both require measured process
...
`P4-10` in [implementation-readiness.md](implementation-readiness.md):
...
The control progress contract in [detailed-runtime.md](../runtime/detailed-runtime.md) is implemented:
...
[shared transfer plan and checkpoint gates](../protocols/detailed-protocol-transfers.md).
...
[fail-fast CI baseline](../development/continuous-integration.md). Cheap preflight gates one
