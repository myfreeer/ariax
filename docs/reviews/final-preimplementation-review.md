...
phase gating in [implementation-plan.md](../project/implementation-plan.md) and [implementation-readiness.md](../project/implementation-readiness.md)
...
Affected documents: [split-download.md](../protocols/split-download.md), [detailed-storage.md](../storage/detailed-storage.md),
[detailed-http-first-slice.md](../protocols/detailed-http-first-slice.md), [metalink-chunking.md](../protocols/metalink-chunking.md), and [configuration.md](../interfaces/configuration.md).
...
Affected documents: [detailed-http-first-slice.md](../protocols/detailed-http-first-slice.md), [detailed-ftp-sftp.md](../protocols/detailed-ftp-sftp.md),
[detailed-storage.md](../storage/detailed-storage.md), [rate-limiting.md](../runtime/rate-limiting.md), [retry-policy.md](../protocols/retry-policy.md), and
[implementation-readiness.md](../project/implementation-readiness.md).
...
Affected documents: [rate-limiting.md](../runtime/rate-limiting.md), [detailed-runtime.md](../runtime/detailed-runtime.md),
[detailed-http-first-slice.md](../protocols/detailed-http-first-slice.md), [detailed-ftp-sftp.md](../protocols/detailed-ftp-sftp.md), [split-download.md](../protocols/split-download.md),
[retry-policy.md](../protocols/retry-policy.md), [stats-and-stalls.md](../runtime/stats-and-stalls.md), [backpressure.md](../runtime/backpressure.md), and [zero-copy.md](../runtime/zero-copy.md).
...
Affected documents: [detailed-core.md](../architecture/detailed-core.md), [retry-policy.md](../protocols/retry-policy.md),
[download-scheduling.md](../runtime/download-scheduling.md), [apis-and-embedding.md](../interfaces/apis-and-embedding.md), and generated state/wire
matrices.
...
Adopted resolution (now normative; [detailed-core.md](../architecture/detailed-core.md) defines
...
Affected documents: [detailed-runtime.md](../runtime/detailed-runtime.md), [messaging-model.md](../runtime/messaging-model.md),
[backpressure.md](../runtime/backpressure.md), and [threading-model.md](../runtime/threading-model.md).
...
Adopted resolution (now normative; [messaging-model.md](../runtime/messaging-model.md) owns the
...
Affected documents: [detailed-storage.md](../storage/detailed-storage.md), [session-persistence.md](../storage/session-persistence.md),
[security-recovery.md](../architecture/security-recovery.md), and [implementation-plan.md](../project/implementation-plan.md).

Segment rotation bounded one file but not a task journal's lifetime size or
startup replay work.

Adopted resolution (normative in [detailed-storage.md](../storage/detailed-storage.md) Checkpoint Compaction
...
Affected documents: [zero-copy.md](../runtime/zero-copy.md), [buffer-pool.md](../runtime/buffer-pool.md), [detailed-runtime.md](../runtime/detailed-runtime.md),
[detailed-http-first-slice.md](../protocols/detailed-http-first-slice.md), [backpressure.md](../runtime/backpressure.md), and [performance-profiles.md](../runtime/performance-profiles.md).
...
- `http_ingress_budget` plus HTTP/1 read-buffer and HTTP/2 window/frame options
  ([protocol-modernization.md](../protocols/protocol-modernization.md)) bound framework memory; connection/stream
...
- The C10k memory gate is the resident-memory equation in
  [performance-profiles.md](../runtime/performance-profiles.md), which includes HTTP-stack, TLS, ingress, queue,
...
Affected documents: [detailed-storage.md](../storage/detailed-storage.md), [retry-policy.md](../protocols/retry-policy.md), and
...
Adopted resolution (normative in [detailed-storage.md](../storage/detailed-storage.md) Finalization and
[retry-policy.md](../protocols/retry-policy.md) Clock rule; v1 record types 22–23):
...
- **Persistence identity and compact state.** [detailed-storage.md](../storage/detailed-storage.md) and
  [session-persistence.md](../storage/session-persistence.md) now bind progress to a canonical output root and
  ...
  ownership.
- **Resident resources and amplification.** [performance-profiles.md](../runtime/performance-profiles.md),
  [configuration.md](../interfaces/configuration.md), [buffer-pool.md](../runtime/buffer-pool.md), and [apis-and-embedding.md](../interfaces/apis-and-embedding.md) now require
  ...
  amplification.
- **Live disk failover.** [disk-adapter.md](../storage/disk-adapter.md) and [event-backends.md](../runtime/event-backends.md) now use a
...
[detailed-ftp-sftp.md](../protocols/detailed-ftp-sftp.md) now defines the host-key verification order (pin,
...
[libtorrent-integration.md](../protocols/libtorrent-integration.md) now rejects torrent symlink entries by default
...
The detailed rationale and research snapshot are in [library-choice.md](../architecture/library-choice.md).
...
- `TransferAttemptId` distinct from `LeaseId` — [detailed-core.md](../architecture/detailed-core.md),
  [detailed-storage.md](../storage/detailed-storage.md).
- Span retry substate (`PlannedSpanState`) and `WaitingSlow` — [detailed-core.md](../architecture/detailed-core.md).
- `CompletionPermit` lifecycle — [messaging-model.md](../runtime/messaging-model.md).
- `http_ingress_budget`, frame/window options, admission formula —
  [detailed-runtime.md](../runtime/detailed-runtime.md), [protocol-modernization.md](../protocols/protocol-modernization.md).
- Rate-accounting counters (received/sent, committed, durable, discarded, rate
  debt) — [stats-and-stalls.md](../runtime/stats-and-stalls.md), [rate-limiting.md](../runtime/rate-limiting.md).
...
- Retry persistence (`scheduled_at`, `delay_ms`, `elapsed_before_wait_ms`,
  reason) and conservative recovery — [detailed-storage.md](../storage/detailed-storage.md), [retry-policy.md](../protocols/retry-policy.md).
- `FinalizeIntent`/`FinalizeDone` idempotent recovery — [detailed-storage.md](../storage/detailed-storage.md).
- SFTP host-key/auth/algorithm/session policy — [detailed-ftp-sftp.md](../protocols/detailed-ftp-sftp.md).
- Torrent symlink and collision policy — [libtorrent-integration.md](../protocols/libtorrent-integration.md).
- Artifact/panic/ABI matrices — [README.md](../architecture/overview.md), [implementation-plan.md](../project/implementation-plan.md) Phase 0.
- Toolchain/lockfile/license/advisory/SBOM artifacts — [library-choice.md](../architecture/library-choice.md),
  [implementation-plan.md](../project/implementation-plan.md) Phase 0.
- Queue defaults and the resident-memory equation —
  [performance-profiles.md](../runtime/performance-profiles.md).
- Persisted root binding, explicit relocation/rebind, and exact SQLite v1 schema
  — [detailed-storage.md](../storage/detailed-storage.md), [session-persistence.md](../storage/session-persistence.md).
- Compact checkpoint `PieceStateChunk` encoding — [detailed-storage.md](../storage/detailed-storage.md).
- Global resident/domain permits, parser/cardinality/cache caps, SFTP external
  ...
  [performance-profiles.md](../runtime/performance-profiles.md), [configuration.md](../interfaces/configuration.md), [apis-and-embedding.md](../interfaces/apis-and-embedding.md).
- Backend epoch, live-failover barrier, and identity-checked handle LRU —
  [disk-adapter.md](../storage/disk-adapter.md), [event-backends.md](../runtime/event-backends.md).
- FTP data-endpoint/control-reply caps, explicit SFTP host-key approval, inbound
  ...
  [detailed-ftp-sftp.md](../protocols/detailed-ftp-sftp.md),
  [protocol-modernization.md](../protocols/protocol-modernization.md), [library-choice.md](../architecture/library-choice.md).
...
in [implementation-plan.md](../project/implementation-plan.md).”
