...
The normative backend contract is defined in [detailed-runtime.md](../runtime/detailed-runtime.md) ("Disk
...
[detailed-storage.md](detailed-storage.md). Linux uses `openat2`/stepwise `openat`, portable Unix
...
normatively in [detailed-storage.md](detailed-storage.md); this document does not restate their
...
Backend selection follows [event-backends.md](../runtime/event-backends.md).
...
fields and state enum are defined normatively in [detailed-runtime.md](../runtime/detailed-runtime.md);
[buffer-pool.md](../runtime/buffer-pool.md) defines allocation and lifecycle policy without a second type.
...
- Explicit resume (or an optional auto-retry timer) first performs the
  allocation/write-readiness probe defined by [detailed-core.md](../architecture/detailed-core.md). Only a
...
[retry-policy.md](../protocols/retry-policy.md) and [backpressure.md](../runtime/backpressure.md) reference this policy rather than
...
to [detailed-storage.md](detailed-storage.md).
