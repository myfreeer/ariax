...
fn render_transport_json(public_suffix: &PublicSuffixPin) -> String {
    ...
    output.push_str(
        concat!(
            "  \"parallel_ranges\": {\"non_overlapping_leases\": true, \"max_pieces\": 1048576, \"default_split\": 5, \"max_split\": 1024, \"default_piece_length\": 1048576, \"max_piece_length\": 1073741824, \"default_max_connections_per_server\": 1, \"max_connections_per_server\": 1024, \"durable_piece_restart_recovery\": true, \"mirror_identity_modes\": [\"strict_shared_digest\", \"trust_submitted_mirrors\"], \"representation_digest\": {\"profile\": \"repr_digest_sha256_exact_range_endgame\", \"request_preference\": \"sha-256=10\", \"max_field_bytes\": 4096, \"max_members\": 16, \"max_key_bytes\": 64, \"max_decoded_member_bytes\": 64, \"probe_body_verified\": true, \"range_body_verified\": true, \"secondary_ordinary_assignments\": false, \"cross_origin_head_equality_required\": true, \"journal_response_digest\": true}},\n",
            ...
            "  \"deferred\": [\"content_digest\", \"representation_digest_parameters_and_coverage\", \"alternate_digest_algorithms\", \"server_advertised_whole_entity_digest_admission\", \"metalink_chunk_identity\", \"http2\", \"growing_or_chunked_transfers\", \"websocket_rpc\", \"ndjson_rpc\", \"non_loopback_rpc\", \"broader_phase_4_control_plane\", \"client_certificates\", \"insecure_verification\", \"native_tls\"]\n",
            "}\n"
        ),
    );
    output
