...
fn render_transport_json(public_suffix: &PublicSuffixPin) -> String {
    ...
    output.push_str(
        concat!(
            ...
            "  \"pool\": {\"scope\": \"process_owned_direct_origin_cache\", \"keep_alive_default\": true, \"default_max_connections_per_origin\": 1, \"default_max_idle_connections_per_origin\": 1, \"max_connections_per_origin\": 8, \"max_idle_connections_per_origin\": 8, \"default_idle_timeout_seconds\": 30, \"standalone_connection_reservation_bytes\": 262144, \"profile_idle_connection_reservation_bytes\": 32768, \"profile_active_tls_connection_ceiling_bytes\": 98304, \"profile_contract\": \"runtime_buffers.json#profile_resources\", \"native_handle_gated\": true, \"shared_process_handle_budget\": true, \"shared_global_resident_budget\": true, \"proxy_capacity_wiring\": \"deferred\", \"file_handle_capacity_wiring\": \"deferred\", \"fresh_destination_admission_per_physical_connection\": true, \"incomplete_or_failed_response_reusable\": false},\n",
...
mod tests {
    ...
    fn direct_transport_contract_freezes_security_and_pool_bounds() {
        ...
        assert!(contract.contains("\"proxy_capacity_wiring\": \"deferred\""));
        assert!(contract.contains("\"file_handle_capacity_wiring\": \"deferred\""));
