...
const SESSION_OUTPUT: &str = "generated/session_v3.json";
...
mod tests {
    ...
    fn generated_session_contract_freezes_schema_limits_and_authority_rules() {
        ...
        assert!(contract.contains("\"schema\": 3"));
        ...
        assert!(!contract.contains("migrations"));
        assert!(contract.contains("\"fresh_v3_store_required\": true"));
        assert!(contract.contains("\"name\": \"bt_metadata\""));
